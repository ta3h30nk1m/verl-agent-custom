...
LORA_ADAPTER_PATH=outputs/mave/fsf_init_lora_1_5b_to_3b_double_normalize_scale1 \
SAVE_PATH=outputs/mave_hyperclovax_faceted_search_filtering_lora_3B_lr5e-5_constant_graddoubletransfer_norm_scale1 \
