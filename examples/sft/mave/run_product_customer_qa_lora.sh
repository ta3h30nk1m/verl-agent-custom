...
SAVE_FREQ=100 \
LORA_ADAPTER_PATH=outputs/mave/pcqa_init_lora_0_5b_to_1_5b_double_normalize_scale_b0_5 \
MODEL_PATH=naver-hyperclovax/HyperCLOVAX-SEED-Text-Instruct-1.5B \
SAVE_PATH=outputs/mave_hyperclovax_product_customer_qa_lora_1_5B_lr1e-4_graddoubletransfer_scaleb0_5 \
